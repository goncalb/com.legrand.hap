...
async function snapshot(homey, maxAgeMs = 2500) {
...
async function moods(homey) {
  try { const a = await api(homey); return a.moods ? Object.values(await a.moods.getMoods()) : []; } catch { return []; }
}
/**
...
module.exports = { api, snapshot, zoneTree, zoneName, zonePath, isLight, isOurs, cap, capValue, isOn, setCapability, moods, setMood };
